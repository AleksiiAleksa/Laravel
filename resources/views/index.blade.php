...
<nav>
     ...
     <div class="row">
        ...
        <div style="margin-right: 20px">
          ...
          @endif
                @if(Auth::check())
             <a href="{{route('cart',['status'=>'in'])}}" class="th"><img src="images/cart.png" width=50 alt="desc" /></a>
                  @else 
                <a href="{{route('cart',['status'=>'out'])}}" class="th"><img src="images/cart.png" width=50 alt="desc" /></a>
                  @endif
        </div>
